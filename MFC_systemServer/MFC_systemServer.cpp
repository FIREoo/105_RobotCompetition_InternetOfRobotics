...
// MFC_systemServer.cpp : 定義應用程式的類別行為。
//
...
BEGIN_MESSAGE_MAP(CMFC_systemServerApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CMFC_systemServerApp 建構

CMFC_systemServerApp::CMFC_systemServerApp()
{
	// 支援重新啟動管理員
...
// 僅有的一個 CMFC_systemServerApp 物件

CMFC_systemServerApp theApp;


// CMFC_systemServerApp 初始設定

BOOL CMFC_systemServerApp::InitInstance()
{
